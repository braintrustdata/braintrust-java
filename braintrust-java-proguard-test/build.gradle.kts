...
dependencies {
    testImplementation(project(":braintrust-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../braintrust-java-core/src/main/resources/META-INF/proguard/braintrust-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../braintrust-java-core/src/main/resources/META-INF/proguard/braintrust-java-core.pro",
