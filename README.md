...
[![Maven Central](https://img.shields.io/maven-central/v/com.braintrustdata.api/braintrust-java)](https://central.sonatype.com/artifact/com.braintrustdata.api/braintrust-java/0.1.0)
...
```kotlin
implementation("com.braintrustdata.api:braintrust-java:0.1.0")
```
