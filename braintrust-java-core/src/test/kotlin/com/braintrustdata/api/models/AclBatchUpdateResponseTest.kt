...
class AclBatchUpdateResponseTest {
    ...
    fun createAclBatchUpdateResponse() {
      val aclBatchUpdateResponse = AclBatchUpdateResponse.builder()
          .addAddedAcl(Acl.builder()
      ...
      assertThat(aclBatchUpdateResponse.addedAcls()).containsExactly(Acl.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          ._objectOrgId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(Acl.ObjectType.ORGANIZATION)
          ...
          .userId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
      assertThat(aclBatchUpdateResponse.removedAcls()).containsExactly(Acl.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          ._objectOrgId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(Acl.ObjectType.ORGANIZATION)
