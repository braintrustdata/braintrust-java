...
class GroupTest {
    ...
    fun createGroup() {
      ...
      assertThat(group.memberGroups().get()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(group.memberUsers().get()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
