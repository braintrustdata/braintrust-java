...
class ProjectScoreListParamsTest {
    ...
    fun createProjectScoreListParams() {
        ProjectScoreListParams.builder()
            ...
            .scoreType(
                ProjectScoreListParams.ScoreType.ofProjectScoreSingle(
                    ProjectScoreListParams.ScoreType.ProjectScoreSingle.SLIDER
                )
            )
    ...
    fun getQueryParams() {
        ...
        expected.put(
            ...
            listOf(
                ProjectScoreListParams.ScoreType.ofProjectScoreSingle(
                        ProjectScoreListParams.ProjectScoreSingle.SLIDER.toString()
                    )
                    .toString()
            )
        )
