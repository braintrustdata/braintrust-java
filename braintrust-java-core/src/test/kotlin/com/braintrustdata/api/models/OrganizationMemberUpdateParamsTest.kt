...
class OrganizationMemberUpdateParamsTest {
    ...
    fun body() {
      ...
      assertNotNull(body)
      assertThat(body.inviteUsers()).contains(OrganizationMemberUpdateParams.InviteUsers.builder()
          .addEmail("string")
          .groupId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .addGroupId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .groupName("group_name")
      ...
      assertThat(body.removeUsers()).contains(OrganizationMemberUpdateParams.RemoveUsers.builder()
          .addEmail("string")
          .addId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    }
