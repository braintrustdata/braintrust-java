...
class InsertProjectLogsEventTest {
    ...
    fun createInsertProjectLogsEvent() {
      ...
      assertThat(insertProjectLogsEvent.context()).contains(InsertProjectLogsEvent.Context.builder()
          .callerFilename("caller_filename")
          .callerFunctionname("caller_functionname")
          .callerLineno(0L)
          .build())
      assertThat(insertProjectLogsEvent.created()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(insertProjectLogsEvent.metadata()).contains(InsertProjectLogsEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(insertProjectLogsEvent.metrics()).contains(InsertProjectLogsEvent.Metrics.builder()
          .callerFilename(JsonValue.from(mapOf<String, Any>()))
          .callerFunctionname(JsonValue.from(mapOf<String, Any>()))
          .callerLineno(JsonValue.from(mapOf<String, Any>()))
          .completionTokens(0L)
      ...
      assertThat(insertProjectLogsEvent.scores()).contains(InsertProjectLogsEvent.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(insertProjectLogsEvent.spanAttributes()).contains(SpanAttributes.builder()
          .name("name")
          .type(SpanAttributes.Type.LLM)
          .build())
