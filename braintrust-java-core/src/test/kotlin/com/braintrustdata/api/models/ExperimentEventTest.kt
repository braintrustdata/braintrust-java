...
class ExperimentEventTest {
    ...
    fun createExperimentEvent() {
      ...
      assertThat(experimentEvent.context()).contains(ExperimentEvent.Context.builder()
          .callerFilename("caller_filename")
          .callerFunctionname("caller_functionname")
          .callerLineno(0L)
          .build())
      ...
      assertThat(experimentEvent.metadata()).contains(ExperimentEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(experimentEvent.metrics()).contains(ExperimentEvent.Metrics.builder()
          .callerFilename(JsonValue.from(mapOf<String, Any>()))
          .callerFunctionname(JsonValue.from(mapOf<String, Any>()))
          .callerLineno(JsonValue.from(mapOf<String, Any>()))
          .completionTokens(0L)
          ...
          .tokens(0L)
          .build())
      assertThat(experimentEvent.origin()).contains(ExperimentEvent.Origin.builder()
          .id("id")
          ._xactId("_xact_id")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(ExperimentEvent.Origin.ObjectType.EXPERIMENT)
      ...
      assertThat(experimentEvent.scores()).contains(ExperimentEvent.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(experimentEvent.spanAttributes()).contains(SpanAttributes.builder()
          .name("name")
          .type(SpanAttributes.Type.LLM)
          .build())
