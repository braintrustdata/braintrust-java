...
class FeedbackExperimentItemTest {
    ...
    fun createFeedbackExperimentItem() {
      ...
      assertThat(feedbackExperimentItem.metadata()).contains(FeedbackExperimentItem.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      ...
      assertThat(feedbackExperimentItem.tags().get()).containsExactly("string")
    }
}
