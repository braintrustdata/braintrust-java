...
class ProjectScoreTest {
    ...
    fun createProjectScore() {
      ...
      assertThat(projectScore.categories()).contains(ProjectScore.Categories.ofCategorical(listOf(ProjectScoreCategory.builder()
          .name("name")
          .value(0.0)
          .build())))
      assertThat(projectScore.config()).contains(ProjectScoreConfig.builder()
          .destination(ProjectScoreConfig.Destination.EXPECTED)
          .multiSelect(true)
          .online(OnlineScoreConfig.builder()
              .samplingRate(0.0)
              ...
              .build())
          .build())
      assertThat(projectScore.created()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
