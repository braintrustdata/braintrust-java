...
class SummarizeExperimentResponseTest {
    ...
    fun createSummarizeExperimentResponse() {
      ...
      assertThat(summarizeExperimentResponse.comparisonExperimentName()).contains("comparison_experiment_name")
      assertThat(summarizeExperimentResponse.metrics()).contains(SummarizeExperimentResponse.Metrics.builder()
          .putAdditionalProperty("foo", JsonValue.from(mapOf(
            "improvements" to 0,
            "metric" to 0,
            "name" to "name",
          ...
          .build())
      assertThat(summarizeExperimentResponse.scores()).contains(SummarizeExperimentResponse.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(mapOf(
            "improvements" to 0,
            "name" to "name",
            "regressions" to 0,
