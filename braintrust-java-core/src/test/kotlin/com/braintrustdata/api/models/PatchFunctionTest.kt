...
class PatchFunctionTest {
    ...
    fun createPatchFunction() {
        ...
        assertThat(patchFunction.description()).contains("description")
        ...
        assertThat(patchFunction.name()).contains("name")
        ...
        assertThat(patchFunction.tags().get()).containsExactly("string")
    }
}
