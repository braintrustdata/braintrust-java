...
class FunctionCreateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.functionSchema()).contains(FunctionCreateParams.FunctionSchema.builder()
          .parameters(JsonValue.from(mapOf<String, Any>()))
          .returns(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(body.functionType()).contains(FunctionCreateParams.FunctionType.LLM)
      assertThat(body.origin()).contains(FunctionCreateParams.Origin.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(FunctionCreateParams.Origin.ObjectType.ORGANIZATION)
          .internal_(true)
          .build())
