...
class InsertDatasetEventTest {
    ...
    fun createInsertDatasetEvent() {
      ...
      assertThat(insertDatasetEvent.created()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      ...
      assertThat(insertDatasetEvent.metadata()).contains(InsertDatasetEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
