...
class ProjectLogsEventTest {
    ...
    fun createProjectLogsEvent() {
      ...
      assertThat(projectLogsEvent.context()).contains(ProjectLogsEvent.Context.builder()
          .callerFilename("caller_filename")
          .callerFunctionname("caller_functionname")
          .callerLineno(0L)
          .build())
      ...
      assertThat(projectLogsEvent.metadata()).contains(ProjectLogsEvent.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(projectLogsEvent.metrics()).contains(ProjectLogsEvent.Metrics.builder()
          .callerFilename(JsonValue.from(mapOf<String, Any>()))
          .callerFunctionname(JsonValue.from(mapOf<String, Any>()))
          .callerLineno(JsonValue.from(mapOf<String, Any>()))
          .completionTokens(0L)
          ...
          .tokens(0L)
          .build())
      assertThat(projectLogsEvent.origin()).contains(ProjectLogsEvent.Origin.builder()
          .id("id")
          ._xactId("_xact_id")
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(ProjectLogsEvent.Origin.ObjectType.EXPERIMENT)
      ...
      assertThat(projectLogsEvent.scores()).contains(ProjectLogsEvent.Scores.builder()
          .putAdditionalProperty("foo", JsonValue.from(0))
          .build())
      assertThat(projectLogsEvent.spanAttributes()).contains(SpanAttributes.builder()
          .name("name")
          .type(SpanAttributes.Type.LLM)
          .build())
