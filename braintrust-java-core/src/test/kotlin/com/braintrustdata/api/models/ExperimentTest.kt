...
class ExperimentTest {
    ...
    fun createExperiment() {
      ...
      assertThat(experiment.deletedAt()).contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
      assertThat(experiment.description()).contains("description")
      assertThat(experiment.metadata()).contains(Experiment.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(experiment.repoInfo()).contains(RepoInfo.builder()
          .authorEmail("author_email")
          .authorName("author_name")
          .branch("branch")
          .commit("commit")
