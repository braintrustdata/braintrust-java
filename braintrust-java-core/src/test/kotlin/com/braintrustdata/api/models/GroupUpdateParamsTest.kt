...
class GroupUpdateParamsTest {
    ...
    fun body() {
      ...
      assertThat(body.removeMemberGroups()).contains(listOf("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"))
      assertThat(body.removeMemberUsers()).contains(listOf("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"))
    }
