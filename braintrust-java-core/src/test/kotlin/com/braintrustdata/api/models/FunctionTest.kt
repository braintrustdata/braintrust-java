...
class FunctionTest {
    ...
    fun createFunction() {
      ...
      assertThat(function.functionSchema()).contains(Function.FunctionSchema.builder()
          .parameters(JsonValue.from(mapOf<String, Any>()))
          .returns(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(function.functionType()).contains(Function.FunctionType.LLM)
      assertThat(function.metadata()).contains(Function.Metadata.builder()
          .putAdditionalProperty("foo", JsonValue.from("bar"))
          .build())
      assertThat(function.origin()).contains(Function.Origin.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .objectType(Function.Origin.ObjectType.ORGANIZATION)
          .internal_(true)
          .build())
      assertThat(function.promptData()).contains(PromptData.builder()
          .options(PromptOptions.builder()
              .model("model")
              .params(PromptOptions.Params.OpenAIModelParams.builder()
                  .frequencyPenalty(0.0)
