...
class SpanIframeServiceTest {
    ...
    fun create() {
      ...
      val spanIFrame = spanIframeService.create(SpanIframeCreateParams.builder()
          .name("name")
    ...
    fun retrieve() {
      ...
      val spanIFrame = spanIframeService.retrieve(SpanIframeRetrieveParams.builder()
    ...
    fun update() {
      ...
      val spanIFrame = spanIframeService.update(SpanIframeUpdateParams.builder()
          .spanIframeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .name("name")
          .postMessage(true)
          .url("url")
    ...
    fun delete() {
      ...
      val spanIFrame = spanIframeService.delete(SpanIframeDeleteParams.builder()
          .spanIframeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun replace() {
      ...
      val spanIFrame = spanIframeService.replace(SpanIframeReplaceParams.builder()
          .name("name")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .url("url")
          .description("description")
