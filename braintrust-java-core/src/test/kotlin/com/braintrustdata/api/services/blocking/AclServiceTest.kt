...
class AclServiceTest {
    ...
    fun list() {
      ...
      val page = aclService.list(AclListParams.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun batchUpdate() {
      ...
      val aclBatchUpdateResponse = aclService.batchUpdate(AclBatchUpdateParams.builder()
    ...
    fun findAndDelete() {
      ...
      val acl = aclService.findAndDelete(AclFindAndDeleteParams.builder()
          .objectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
