...
class ProjectScoreServiceAsyncTest {
    ...
    fun create() {
      ...
      val projectScoreFuture = projectScoreServiceAsync.create(ProjectScoreCreateParams.builder()
          .name("name")
    ...
    fun retrieve() {
      ...
      val projectScoreFuture = projectScoreServiceAsync.retrieve(ProjectScoreRetrieveParams.builder()
    ...
    fun update() {
      ...
      val projectScoreFuture = projectScoreServiceAsync.update(ProjectScoreUpdateParams.builder()
          .projectScoreId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .categoriesOfCategorical(listOf(ProjectScoreCategory.builder()
              .name("name")
              .value(0.0)
    ...
    fun delete() {
      ...
      val projectScoreFuture = projectScoreServiceAsync.delete(ProjectScoreDeleteParams.builder()
          .projectScoreId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun replace() {
      ...
      val projectScoreFuture = projectScoreServiceAsync.replace(ProjectScoreReplaceParams.builder()
          .name("name")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
