...
class ApiKeyServiceTest {
    ...
    fun create() {
      ...
      val createApiKeyOutput = apiKeyService.create(ApiKeyCreateParams.builder()
          .name("name")
          .orgName("org_name")
          .build())
    ...
    fun retrieve() {
      ...
      val apiKey = apiKeyService.retrieve(ApiKeyRetrieveParams.builder()
    ...
    fun delete() {
      ...
      val apiKey = apiKeyService.delete(ApiKeyDeleteParams.builder()
          .apiKeyId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
