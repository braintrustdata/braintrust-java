...
class FunctionServiceAsyncTest {
    ...
    fun create() {
      ...
      val functionFuture = functionServiceAsync.create(FunctionCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val functionFuture = functionServiceAsync.retrieve(FunctionRetrieveParams.builder()
    ...
    fun update() {
      ...
      val functionFuture = functionServiceAsync.update(FunctionUpdateParams.builder()
          .functionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
    ...
    fun delete() {
      ...
      val functionFuture = functionServiceAsync.delete(FunctionDeleteParams.builder()
          .functionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun invoke() {
      ...
      val responseFuture = functionServiceAsync.invoke(FunctionInvokeParams.builder()
          .functionId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun replace() {
      ...
      val functionFuture = functionServiceAsync.replace(FunctionReplaceParams.builder()
