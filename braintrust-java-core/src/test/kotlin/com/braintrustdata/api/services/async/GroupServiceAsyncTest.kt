...
internal class GroupServiceAsyncTest {
    ...
    fun retrieve() {
        ...
        val groupFuture = groupServiceAsync.retrieve("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun delete() {
        ...
        val groupFuture = groupServiceAsync.delete("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
