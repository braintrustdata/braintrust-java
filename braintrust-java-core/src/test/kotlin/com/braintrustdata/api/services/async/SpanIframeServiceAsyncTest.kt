...
class SpanIframeServiceAsyncTest {
    ...
    fun create() {
      ...
      val spanIFrameFuture = spanIframeServiceAsync.create(SpanIframeCreateParams.builder()
          .name("name")
    ...
    fun retrieve() {
      ...
      val spanIFrameFuture = spanIframeServiceAsync.retrieve(SpanIframeRetrieveParams.builder()
    ...
    fun update() {
      ...
      val spanIFrameFuture = spanIframeServiceAsync.update(SpanIframeUpdateParams.builder()
          .spanIframeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .name("name")
          .postMessage(true)
          .url("url")
    ...
    fun delete() {
      ...
      val spanIFrameFuture = spanIframeServiceAsync.delete(SpanIframeDeleteParams.builder()
          .spanIframeId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun replace() {
      ...
      val spanIFrameFuture = spanIframeServiceAsync.replace(SpanIframeReplaceParams.builder()
          .name("name")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .url("url")
          .description("description")
