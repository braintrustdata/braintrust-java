...
class DatasetServiceAsyncTest {
    ...
    fun create() {
      ...
      val datasetFuture = datasetServiceAsync.create(DatasetCreateParams.builder()
          .name("x")
    ...
    fun retrieve() {
      ...
      val datasetFuture = datasetServiceAsync.retrieve(DatasetRetrieveParams.builder()
    ...
    fun update() {
      ...
      val datasetFuture = datasetServiceAsync.update(DatasetUpdateParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
    ...
    fun delete() {
      ...
      val datasetFuture = datasetServiceAsync.delete(DatasetDeleteParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun feedback() {
      ...
      val feedbackResponseSchemaFuture = datasetServiceAsync.feedback(DatasetFeedbackParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun fetch() {
      ...
      val fetchDatasetEventsResponseFuture = datasetServiceAsync.fetch(DatasetFetchParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .limit(0L)
    ...
    fun fetchPost() {
      ...
      val fetchDatasetEventsResponseFuture = datasetServiceAsync.fetchPost(DatasetFetchPostParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .cursor("cursor")
          .limit(0L)
          .maxRootSpanId("max_root_span_id")
    ...
    fun insert() {
      ...
      val insertEventsResponseFuture = datasetServiceAsync.insert(DatasetInsertParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
    ...
    fun summarize() {
      ...
      val summarizeDatasetResponseFuture = datasetServiceAsync.summarize(DatasetSummarizeParams.builder()
          .datasetId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .summarizeData(true)
          .build())
