...
class PromptServiceAsyncTest {
    ...
    fun create() {
      ...
      val promptFuture = promptServiceAsync.create(PromptCreateParams.builder()
          .name("x")
    ...
    fun retrieve() {
      ...
      val promptFuture = promptServiceAsync.retrieve(PromptRetrieveParams.builder()
    ...
    fun update() {
      ...
      val promptFuture = promptServiceAsync.update(PromptUpdateParams.builder()
          .promptId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .description("description")
          .name("name")
          .promptData(PromptData.builder()
    ...
    fun delete() {
      ...
      val promptFuture = promptServiceAsync.delete(PromptDeleteParams.builder()
          .promptId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
    ...
    fun replace() {
      ...
      val promptFuture = promptServiceAsync.replace(PromptReplaceParams.builder()
          .name("x")
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .slug("x")
          .description("description")
