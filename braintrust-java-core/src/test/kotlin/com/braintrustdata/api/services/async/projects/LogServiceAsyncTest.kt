...
class LogServiceAsyncTest {
    ...
    fun feedback() {
      ...
      val feedbackResponseSchemaFuture = logServiceAsync.feedback(ProjectLogFeedbackParams.builder()
    ...
    fun fetch() {
      ...
      val fetchProjectLogsEventsResponseFuture = logServiceAsync.fetch(ProjectLogFetchParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .limit(0L)
    ...
    fun fetchPost() {
      ...
      val fetchProjectLogsEventsResponseFuture = logServiceAsync.fetchPost(ProjectLogFetchPostParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .cursor("cursor")
          .limit(0L)
          .maxRootSpanId("max_root_span_id")
    ...
    fun insert() {
      ...
      val insertEventsResponseFuture = logServiceAsync.insert(ProjectLogInsertParams.builder()
          .projectId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
