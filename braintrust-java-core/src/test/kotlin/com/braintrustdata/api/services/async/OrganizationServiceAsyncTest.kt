...
class OrganizationServiceAsyncTest {
    ...
    fun retrieve() {
      ...
      val organizationFuture = organizationServiceAsync.retrieve(OrganizationRetrieveParams.builder()
    ...
    fun delete() {
      ...
      val organizationFuture = organizationServiceAsync.delete(OrganizationDeleteParams.builder()
          .organizationId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .build())
