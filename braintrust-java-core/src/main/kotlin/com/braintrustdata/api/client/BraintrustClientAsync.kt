...
/**
 * A client for interacting with the Braintrust REST API asynchronously. You can
...
interface BraintrustClientAsync {
    ...
    /**
     * A view of [BraintrustClientAsync] that provides access to raw HTTP responses for
     * each method.
     */
