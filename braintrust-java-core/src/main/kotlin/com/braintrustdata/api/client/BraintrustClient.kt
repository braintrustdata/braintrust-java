...
/**
 * A client for interacting with the Braintrust REST API synchronously. You can
...
interface BraintrustClient {
    ...
    /**
     * A view of [BraintrustClient] that provides access to raw HTTP responses for each
     * method.
     */
