...
interface RoleServiceAsync {
    ...
    /** @see [create] */
    fun create(params: RoleCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Role>
    ...
    /** @see [retrieve] */
    fun retrieve(params: RoleRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Role>
    ...
    /** @see [update] */
    fun update(params: RoleUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Role>
    ...
    /** @see [list] */
    fun list(params: RoleListParams = RoleListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<RoleListPageAsync>
    ...
    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<RoleListPageAsync> = list(RoleListParams.none(), requestOptions)
    ...
    /** @see [delete] */
    fun delete(params: RoleDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Role>
    ...
    /** @see [replace] */
    fun replace(params: RoleReplaceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<Role>
    ...
    interface WithRawResponse {
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: RoleCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Role>>
        ...
        /** @see [retrieve] */
        @MustBeClosed
        fun retrieve(params: RoleRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Role>>
        ...
        /** @see [update] */
        @MustBeClosed
        fun update(params: RoleUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Role>>
         ...
         */
        @MustBeClosed
        fun list(): CompletableFuture<HttpResponseFor<RoleListPageAsync>> = list(RoleListParams.none())

        /** @see [list] */
        @MustBeClosed
        fun list(params: RoleListParams = RoleListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<RoleListPageAsync>>

        /** @see [list] */
        @MustBeClosed
        fun list(params: RoleListParams = RoleListParams.none()): CompletableFuture<HttpResponseFor<RoleListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<RoleListPageAsync>> = list(RoleListParams.none(), requestOptions)
        ...
        /** @see [delete] */
        @MustBeClosed
        fun delete(params: RoleDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Role>>
        ...
        /** @see [replace] */
        @MustBeClosed
        fun replace(params: RoleReplaceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Role>>
    }
}
