...
class GroupServiceAsyncImpl internal constructor(
    ...
    override fun create(params: GroupCreateParams, requestOptions: RequestOptions): CompletableFuture<Group> =
        // post /v1/group
    ...
    override fun update(params: GroupUpdateParams, requestOptions: RequestOptions): CompletableFuture<Group> =
        // patch /v1/group/{group_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: GroupListParams, requestOptions: RequestOptions): CompletableFuture<GroupListPageAsync> =
        // get /v1/group
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: GroupDeleteParams, requestOptions: RequestOptions): CompletableFuture<Group> =
        // delete /v1/group/{group_id}
        withRawResponse().delete(params, requestOptions).thenApply { it.parse() }

    override fun replace(params: GroupReplaceParams, requestOptions: RequestOptions): CompletableFuture<Group> =
        // put /v1/group
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: GroupCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Group>> {
        ...
        override fun update(params: GroupUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Group>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: GroupListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<GroupListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "group")
            .build()
        ...
        override fun delete(params: GroupDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Group>> {
          val request = HttpRequest.builder()
        ...
        override fun replace(params: GroupReplaceParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Group>> {
          val request = HttpRequest.builder()
