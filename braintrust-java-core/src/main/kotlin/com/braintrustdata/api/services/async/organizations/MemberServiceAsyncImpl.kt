...
class MemberServiceAsyncImpl internal constructor(
    ...
    override fun update(params: OrganizationMemberUpdateParams, requestOptions: RequestOptions): CompletableFuture<PatchOrganizationMembersOutput> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun update(params: OrganizationMemberUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PatchOrganizationMembersOutput>> {
