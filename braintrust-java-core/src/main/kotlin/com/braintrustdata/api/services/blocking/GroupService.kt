...
interface GroupService {
     ...
     */
    fun create(params: GroupCreateParams): Group =
        create(
    ...
    fun retrieve(params: GroupRetrieveParams): Group =
        retrieve(
          params, RequestOptions.none()
        )
     ...
     */
    fun update(params: GroupUpdateParams): Group =
        update(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: GroupDeleteParams): Group =
        delete(
          params, RequestOptions.none()
        )
     ...
     * fields
     */
    fun replace(params: GroupReplaceParams): Group =
        replace(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<GroupListPage> = list(GroupListParams.none())
