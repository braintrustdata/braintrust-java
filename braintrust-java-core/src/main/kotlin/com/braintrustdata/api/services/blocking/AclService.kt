...
interface AclService {
     ...
     */
    fun create(params: AclCreateParams): Acl =
        create(
    ...
    fun retrieve(params: AclRetrieveParams): Acl =
        retrieve(
          params, RequestOptions.none()
        )
     ...
     */
    fun list(params: AclListParams): AclListPage =
        list(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: AclDeleteParams): Acl =
        delete(
          params, RequestOptions.none()
        )
    ...
    /** @see [batchUpdate] */
    fun batchUpdate(params: AclBatchUpdateParams = AclBatchUpdateParams.none()): AclBatchUpdateResponse =
        batchUpdate(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun batchUpdate(): HttpResponseFor<AclBatchUpdateResponse> = batchUpdate(AclBatchUpdateParams.none())
        ...
        /** @see [batchUpdate] */
        @MustBeClosed
        fun batchUpdate(params: AclBatchUpdateParams = AclBatchUpdateParams.none()): HttpResponseFor<AclBatchUpdateResponse> =
            batchUpdate(
              params, RequestOptions.none()
            )
