...
interface AiSecretService {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): AiSecretService
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): AiSecretService.WithRawResponse
