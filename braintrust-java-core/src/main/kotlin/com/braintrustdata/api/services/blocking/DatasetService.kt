...
interface DatasetService {
     ...
     * unmodified
     */
    fun create(params: DatasetCreateParams): Dataset =
        create(
    ...
    fun retrieve(params: DatasetRetrieveParams): Dataset =
        retrieve(
          params, RequestOptions.none()
        )
     ...
     */
    fun update(params: DatasetUpdateParams): Dataset =
        update(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: DatasetDeleteParams): Dataset =
        delete(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<DatasetListPage> = list(DatasetListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: DatasetListParams = DatasetListParams.none()): HttpResponseFor<DatasetListPage> =
            list(
              params, RequestOptions.none()
            )
