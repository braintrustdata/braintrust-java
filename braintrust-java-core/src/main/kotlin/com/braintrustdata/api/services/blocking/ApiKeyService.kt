...
interface ApiKeyService {
    ...
    fun retrieve(params: ApiKeyRetrieveParams): ApiKey =
        retrieve(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: ApiKeyDeleteParams): ApiKey =
        delete(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(): HttpResponseFor<ApiKeyListPage> = list(ApiKeyListParams.none())
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: ApiKeyListParams = ApiKeyListParams.none()): HttpResponseFor<ApiKeyListPage> =
            list(
              params, RequestOptions.none()
            )
