...
interface FunctionService {
     ...
     * unmodified
     */
    fun create(params: FunctionCreateParams): Function =
        create(
    ...
    fun retrieve(params: FunctionRetrieveParams): Function =
        retrieve(
          params, RequestOptions.none()
        )
     ...
     */
    fun update(params: FunctionUpdateParams): Function =
        update(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: FunctionDeleteParams): Function =
        delete(
          params, RequestOptions.none()
        )
    ...
    /** @see [invoke] */
    fun invoke(params: FunctionInvokeParams, requestOptions: RequestOptions = RequestOptions.none()): Optional<FunctionInvokeResponse>
     ...
     */
    fun replace(params: FunctionReplaceParams): Function =
        replace(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: FunctionListParams = FunctionListParams.none()): HttpResponseFor<FunctionListPage> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun invoke(params: FunctionInvokeParams): HttpResponseFor<Optional<FunctionInvokeResponse>> =
            invoke(
              params, RequestOptions.none()
            )
        ...
        /** @see [invoke] */
        @MustBeClosed
        fun invoke(params: FunctionInvokeParams, requestOptions: RequestOptions = RequestOptions.none()): HttpResponseFor<Optional<FunctionInvokeResponse>>
