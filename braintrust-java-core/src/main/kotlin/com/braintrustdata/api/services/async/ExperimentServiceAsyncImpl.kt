...
class ExperimentServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : ExperimentServiceAsync {
    ...
    override fun feedback(params: ExperimentFeedbackParams, requestOptions: RequestOptions): CompletableFuture<Void> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun fetch(params: ExperimentFetchParams, requestOptions: RequestOptions): CompletableFuture<ExperimentFetchResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun fetchPost(params: ExperimentFetchPostParams, requestOptions: RequestOptions): CompletableFuture<ExperimentFetchPostResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "experiment", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun insert(params: ExperimentInsertParams, requestOptions: RequestOptions): CompletableFuture<ExperimentInsertResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    override fun summarize(params: ExperimentSummarizeParams, requestOptions: RequestOptions): CompletableFuture<ExperimentSummarizeResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
