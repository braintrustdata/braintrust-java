...
class ExperimentServiceAsyncImpl internal constructor(
    ...
    override fun create(params: ExperimentCreateParams, requestOptions: RequestOptions): CompletableFuture<Experiment> =
        // post /v1/experiment
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: ExperimentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Experiment> =
        // get /v1/experiment/{experiment_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: ExperimentUpdateParams, requestOptions: RequestOptions): CompletableFuture<Experiment> =
        // patch /v1/experiment/{experiment_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: ExperimentListParams, requestOptions: RequestOptions): CompletableFuture<ExperimentListPageAsync> =
        // get /v1/experiment
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: ExperimentDeleteParams, requestOptions: RequestOptions): CompletableFuture<Experiment> =
        // delete /v1/experiment/{experiment_id}
        withRawResponse().delete(params, requestOptions).thenApply { it.parse() }

    override fun feedback(params: ExperimentFeedbackParams, requestOptions: RequestOptions): CompletableFuture<FeedbackResponseSchema> =
        // post /v1/experiment/{experiment_id}/feedback
        withRawResponse().feedback(params, requestOptions).thenApply { it.parse() }

    override fun fetch(params: ExperimentFetchParams, requestOptions: RequestOptions): CompletableFuture<FetchExperimentEventsResponse> =
        // get /v1/experiment/{experiment_id}/fetch
        withRawResponse().fetch(params, requestOptions).thenApply { it.parse() }

    override fun fetchPost(params: ExperimentFetchPostParams, requestOptions: RequestOptions): CompletableFuture<FetchExperimentEventsResponse> =
        // post /v1/experiment/{experiment_id}/fetch
        withRawResponse().fetchPost(params, requestOptions).thenApply { it.parse() }

    override fun insert(params: ExperimentInsertParams, requestOptions: RequestOptions): CompletableFuture<InsertEventsResponse> =
        // post /v1/experiment/{experiment_id}/insert
        withRawResponse().insert(params, requestOptions).thenApply { it.parse() }

    override fun summarize(params: ExperimentSummarizeParams, requestOptions: RequestOptions): CompletableFuture<SummarizeExperimentResponse> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: ExperimentCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Experiment>> {
        ...
        override fun retrieve(params: ExperimentRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Experiment>> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: ExperimentUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Experiment>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: ExperimentListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<ExperimentListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "experiment")
            .build()
        ...
        override fun delete(params: ExperimentDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Experiment>> {
          val request = HttpRequest.builder()
        ...
        override fun feedback(params: ExperimentFeedbackParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<FeedbackResponseSchema>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun fetch(params: ExperimentFetchParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<FetchExperimentEventsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
        ...
        override fun fetchPost(params: ExperimentFetchPostParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<FetchExperimentEventsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("v1", "experiment", params.getPathParam(0), "fetch")
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun insert(params: ExperimentInsertParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<InsertEventsResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
        ...
        override fun summarize(params: ExperimentSummarizeParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<SummarizeExperimentResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
