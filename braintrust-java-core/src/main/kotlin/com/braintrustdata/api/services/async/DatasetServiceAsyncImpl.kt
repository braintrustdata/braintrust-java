...
class DatasetServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : DatasetServiceAsync {
    ...
    override fun feedback(params: DatasetFeedbackParams, requestOptions: RequestOptions): CompletableFuture<Void> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
     ...
     */
    override fun fetch(params: DatasetFetchParams, requestOptions: RequestOptions): CompletableFuture<DatasetFetchResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
     ...
     */
    override fun fetchPost(params: DatasetFetchPostParams, requestOptions: RequestOptions): CompletableFuture<DatasetFetchPostResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "dataset", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun insert(params: DatasetInsertParams, requestOptions: RequestOptions): CompletableFuture<DatasetInsertResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
    ...
    /** Summarize dataset */
    override fun summarize(params: DatasetSummarizeParams, requestOptions: RequestOptions): CompletableFuture<DatasetSummarizeResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.GET)
