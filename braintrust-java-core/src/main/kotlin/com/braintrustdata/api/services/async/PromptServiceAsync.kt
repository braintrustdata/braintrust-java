...
interface PromptServiceAsync {
    ...
    /** @see [list] */
    fun list(params: PromptListParams = PromptListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<PromptListPageAsync>

    /** @see [list] */
    fun list(params: PromptListParams = PromptListParams.none()): CompletableFuture<PromptListPageAsync> =
        list(
          params, RequestOptions.none()
        )

    /** @see [list] */
    fun list(requestOptions: RequestOptions): CompletableFuture<PromptListPageAsync> = list(PromptListParams.none(), requestOptions)
    ...
    interface WithRawResponse {
        ...
        /** @see [create] */
        @MustBeClosed
        fun create(params: PromptCreateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Prompt>>
        ...
        /** @see [retrieve] */
        @MustBeClosed
        fun retrieve(params: PromptRetrieveParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Prompt>>
        ...
        /** @see [update] */
        @MustBeClosed
        fun update(params: PromptUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Prompt>>
         ...
         */
        @MustBeClosed
        fun list(): CompletableFuture<HttpResponseFor<PromptListPageAsync>> = list(PromptListParams.none())

        /** @see [list] */
        @MustBeClosed
        fun list(params: PromptListParams = PromptListParams.none(), requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<PromptListPageAsync>>

        /** @see [list] */
        @MustBeClosed
        fun list(params: PromptListParams = PromptListParams.none()): CompletableFuture<HttpResponseFor<PromptListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PromptListPageAsync>> = list(PromptListParams.none(), requestOptions)
        ...
        /** @see [delete] */
        @MustBeClosed
        fun delete(params: PromptDeleteParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Prompt>>
        ...
        /** @see [replace] */
        @MustBeClosed
        fun replace(params: PromptReplaceParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<Prompt>>
    }
}
