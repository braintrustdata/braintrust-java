...
class PromptServiceAsyncImpl internal constructor(
    ...
    override fun create(params: PromptCreateParams, requestOptions: RequestOptions): CompletableFuture<Prompt> =
        // post /v1/prompt
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: PromptRetrieveParams, requestOptions: RequestOptions): CompletableFuture<Prompt> =
        // get /v1/prompt/{prompt_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: PromptUpdateParams, requestOptions: RequestOptions): CompletableFuture<Prompt> =
        // patch /v1/prompt/{prompt_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: PromptListParams, requestOptions: RequestOptions): CompletableFuture<PromptListPageAsync> =
        // get /v1/prompt
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun delete(params: PromptDeleteParams, requestOptions: RequestOptions): CompletableFuture<Prompt> =
        // delete /v1/prompt/{prompt_id}
        withRawResponse().delete(params, requestOptions).thenApply { it.parse() }

    override fun replace(params: PromptReplaceParams, requestOptions: RequestOptions): CompletableFuture<Prompt> =
        // put /v1/prompt
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: PromptCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Prompt>> {
        ...
        override fun retrieve(params: PromptRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Prompt>> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: PromptUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Prompt>> {
          val request = HttpRequest.builder()
        ...
        override fun list(params: PromptListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<PromptListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("v1", "prompt")
            .build()
        ...
        override fun delete(params: PromptDeleteParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Prompt>> {
          val request = HttpRequest.builder()
        ...
        override fun replace(params: PromptReplaceParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<Prompt>> {
          val request = HttpRequest.builder()
