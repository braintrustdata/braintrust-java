...
interface ExperimentService {
     ...
     */
    fun create(params: ExperimentCreateParams): Experiment =
        create(
     ...
     */
    fun update(params: ExperimentUpdateParams): Experiment =
        update(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: ExperimentDeleteParams): Experiment =
        delete(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: ExperimentListParams = ExperimentListParams.none()): HttpResponseFor<ExperimentListPage> =
            list(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun fetchPost(params: ExperimentFetchPostParams): HttpResponseFor<FetchExperimentEventsResponse> =
            fetchPost(
              params, RequestOptions.none()
            )
         ...
         */
        @MustBeClosed
        fun summarize(params: ExperimentSummarizeParams): HttpResponseFor<SummarizeExperimentResponse> =
            summarize(
              params, RequestOptions.none()
            )
