...
interface SpanIframeService {
     ...
     * unmodified
     */
    fun create(params: SpanIframeCreateParams): SpanIFrame =
        create(
     ...
     */
    fun update(params: SpanIframeUpdateParams): SpanIFrame =
        update(
          params, RequestOptions.none()
        )
    ...
    fun delete(params: SpanIframeDeleteParams): SpanIFrame =
        delete(
          params, RequestOptions.none()
        )
    ...
    interface WithRawResponse {
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: SpanIframeListParams = SpanIframeListParams.none()): HttpResponseFor<SpanIframeListPage> =
            list(
              params, RequestOptions.none()
            )
