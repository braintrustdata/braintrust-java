...
class LogServiceAsyncImpl constructor(private val clientOptions: ClientOptions, ) : LogServiceAsync {
    ...
    override fun feedback(params: ProjectLogFeedbackParams, requestOptions: RequestOptions): CompletableFuture<Void> {
     ...
     */
    override fun fetch(params: ProjectLogFetchParams, requestOptions: RequestOptions): CompletableFuture<ProjectLogFetchResponse> {
      val request = HttpRequest.builder()
     ...
     */
    override fun fetchPost(params: ProjectLogFetchPostParams, requestOptions: RequestOptions): CompletableFuture<ProjectLogFetchPostResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
        .addPathSegments("v1", "project_logs", params.getPathParam(0), "fetch")
        .putAllQueryParams(clientOptions.queryParams)
    ...
    override fun insert(params: ProjectLogInsertParams, requestOptions: RequestOptions): CompletableFuture<ProjectLogInsertResponse> {
      val request = HttpRequest.builder()
        .method(HttpMethod.POST)
