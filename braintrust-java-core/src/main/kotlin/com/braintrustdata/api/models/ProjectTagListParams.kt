...
class ProjectTagListParams private constructor(
    ...
    fun projectTagName(): Optional<String> = Optional.ofNullable(projectTagName)
    ...
    class Builder internal constructor() {
        ...
        /** Name of the project_tag to search for */
        fun projectTagName(projectTagName: Optional<String>) = projectTagName(projectTagName.getOrNull())
