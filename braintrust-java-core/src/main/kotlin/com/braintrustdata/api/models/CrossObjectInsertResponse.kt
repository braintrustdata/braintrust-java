...
class CrossObjectInsertResponse @JsonCreator private constructor(
    ...
    fun experiment(): Optional<Experiment> = Optional.ofNullable(experiment.getNullable("experiment"))

    /** A mapping from project id to row ids for inserted `events` */
    fun projectLogs(): Optional<ProjectLogs> = Optional.ofNullable(projectLogs.getNullable("project_logs"))
