...
class ExperimentSummarizeParams private constructor(
    ...
    class Builder internal constructor() {
         ...
         * `summarize_scores=true` for this id to be used
         */
        fun comparisonExperimentId(comparisonExperimentId: Optional<String>) = comparisonExperimentId(comparisonExperimentId.getOrNull())
         ...
         * metadata will be returned.
         */
        fun summarizeScores(summarizeScores: Optional<Boolean>) = summarizeScores(summarizeScores.getOrNull())
