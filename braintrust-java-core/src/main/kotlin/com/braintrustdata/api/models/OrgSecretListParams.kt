...
constructor(
    ...
    fun orgSecretName(): Optional<String> = Optional.ofNullable(orgSecretName)

    fun orgSecretType(): Optional<OrgSecretType> = Optional.ofNullable(orgSecretType)
    ...
    private constructor(
        ...
        companion object {
            ...
            @JvmStatic fun ofString(string: String) = OrgSecretType(string = string)

            @JvmStatic fun ofStrings(strings: List<String>) = OrgSecretType(strings = strings)
        }
