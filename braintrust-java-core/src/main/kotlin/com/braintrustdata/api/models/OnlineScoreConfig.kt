...
class OnlineScoreConfig @JsonCreator private constructor(
    ...
    fun applyToRootSpan(): Optional<Boolean> = Optional.ofNullable(applyToRootSpan.getNullable("apply_to_root_span"))

    /** Trigger online scoring on any spans with a name in this list */
    fun applyToSpanNames(): Optional<List<String>> = Optional.ofNullable(applyToSpanNames.getNullable("apply_to_span_names"))
    ...
    class Builder internal constructor() {
        ...
        /** Whether to trigger online scoring on the root span of each trace */
        fun applyToRootSpan(applyToRootSpan: Optional<Boolean>) = applyToRootSpan(applyToRootSpan.getOrNull())
        ...
        /** Trigger online scoring on any spans with a name in this list */
        fun applyToSpanNames(applyToSpanNames: Optional<List<String>>) = applyToSpanNames(applyToSpanNames.getOrNull())
