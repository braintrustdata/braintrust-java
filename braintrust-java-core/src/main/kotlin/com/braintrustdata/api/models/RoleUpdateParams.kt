...
class RoleUpdateParams private constructor(
    ...
    fun removeMemberPermissions(): Optional<List<RemoveMemberPermission>> = body.removeMemberPermissions()
    ...
    class Body @JsonCreator private constructor(
        ...
        /** A list of permissions to add to the role */
        fun addMemberPermissions(): Optional<List<AddMemberPermission>> = Optional.ofNullable(addMemberPermissions.getNullable("add_member_permissions"))

        /** A list of role IDs to add to the role's inheriting-from set */
        fun addMemberRoles(): Optional<List<String>> = Optional.ofNullable(addMemberRoles.getNullable("add_member_roles"))
        ...
        /** A list of permissions to remove from the role */
        fun removeMemberPermissions(): Optional<List<RemoveMemberPermission>> = Optional.ofNullable(removeMemberPermissions.getNullable("remove_member_permissions"))

        /** A list of role IDs to remove from the role's inheriting-from set */
        fun removeMemberRoles(): Optional<List<String>> = Optional.ofNullable(removeMemberRoles.getNullable("remove_member_roles"))
        ...
        class Builder internal constructor() {
            ...
            /** A list of permissions to add to the role */
            fun addMemberPermissions(addMemberPermissions: Optional<List<AddMemberPermission>>) = addMemberPermissions(addMemberPermissions.getOrNull())
            ...
            /** A list of role IDs to add to the role's inheriting-from set */
            fun addMemberRoles(addMemberRoles: Optional<List<String>>) = addMemberRoles(addMemberRoles.getOrNull())
            ...
            /** A list of permissions to remove from the role */
            fun removeMemberPermissions(removeMemberPermissions: Optional<List<RemoveMemberPermission>>) = removeMemberPermissions(removeMemberPermissions.getOrNull())
            ...
            /** A list of role IDs to remove from the role's inheriting-from set */
            fun removeMemberRoles(removeMemberRoles: Optional<List<String>>) = removeMemberRoles(removeMemberRoles.getOrNull())
