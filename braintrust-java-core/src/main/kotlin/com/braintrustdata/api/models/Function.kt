...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            fun promptId(): Optional<String> =
                Optional.ofNullable(promptId.getNullable("prompt_id"))

            fun projectId(): Optional<String> =
                Optional.ofNullable(projectId.getNullable("project_id"))
                    ...
                    private constructor(
                        ...
                        private constructor(
                            ...
                            private constructor(
                                ...
                                override fun toString(): String {
                                    return when {
                                        text != null -> "UnnamedSchemaWithArrayParent7{text=$text}"
                                        imageUrl != null ->
                                            "UnnamedSchemaWithArrayParent7{imageUrl=$imageUrl}"
                                        _json != null ->
                                ...
                                companion object {
                                    ...
                                    fun ofText(text: Text) =
                                        UnnamedSchemaWithArrayParent7(text = text)
