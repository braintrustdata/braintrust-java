...
class ExperimentFetchPostParams private constructor(
    ...
    class Body @JsonCreator private constructor(
         ...
         * for an overview of paginating fetch queries.
         */
        fun maxRootSpanId(): Optional<String> = Optional.ofNullable(maxRootSpanId.getNullable("max_root_span_id"))
        ...
        class Builder internal constructor() {
             ...
             * for an overview of paginating fetch queries.
             */
            fun maxRootSpanId(maxRootSpanId: Optional<String>) = maxRootSpanId(maxRootSpanId.getOrNull())
