...
class FunctionInvokeParams private constructor(
    ...
    class Body @JsonCreator private constructor(
        ...
        /** If the function is an LLM, additional messages to pass along to it */
        fun messages(): Optional<List<Message>> = Optional.ofNullable(messages.getNullable("messages"))
    ...
    class Parent private constructor(
        ...
        class SpanParentStruct @JsonCreator private constructor(
            ...
            fun propagatedEvent(): Optional<PropagatedEvent> = Optional.ofNullable(propagatedEvent.getNullable("propagated_event"))
            ...
            class Builder internal constructor() {
                ...
                /** Include these properties in every span created under this parent */
                fun propagatedEvent(propagatedEvent: Optional<PropagatedEvent>) = propagatedEvent(propagatedEvent.getOrNull())
