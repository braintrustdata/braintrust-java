...
private constructor(
    ...
    fun spanIframeName(): Optional<String> = Optional.ofNullable(spanIframeName)
    ...
    class Builder internal constructor() {
        ...
        /** Alias for calling [Builder.spanIframeName] with `spanIframeName.orElse(null)`. */
        fun spanIframeName(spanIframeName: Optional<String>) =
            spanIframeName(spanIframeName.getOrNull())
